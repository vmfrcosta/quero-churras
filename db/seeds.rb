...
grill_params = [
{
  ...
  name: "Churrasqueira à Gás Genesis S-340 Weber",
...
{
  user: User.find_by_first_name('Vinicius'),
  name: "Churrasqueira Media à carvao portatil" ,
...
{
  user: User.find_by_first_name('Vinicius'),
  name: "Churrasqueira à bafo portátil para camping e lazer Ntk Alexias Texas carvão redonda nautika",
...
{
  user: User.find_by_first_name('Vinicius'),
  name: "Churrasqueira à gás de bancada 3 queimadores inox",
